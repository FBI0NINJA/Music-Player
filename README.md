...
A modern desktop music player built with Python that allows users to search, stream, and download songs directly from YouTube.
...
The app can be converted to EXE and run without installing Python
...
This project was built to practice Python desktop development and working with media streaming and downloading.
...
🎵 Add user authentication system (Login)
